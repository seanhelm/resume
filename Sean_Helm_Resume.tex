...
%\titleformat{\section}{\scshape\Large}{}{0pt}{#1\,\raisedrulefill[0.4ex]{0.5pt}}
...
\begin{itemize}
\item Architected a caching solution for a big data exploration platform to reduce retrieval latency for recently run Snowflake queries.
\item Lowered operational costs by enabling lifecycle management for the underlying cache and metadata.
\end{itemize}
...
\school{George Mason University}{Bachelor of Science in Computer Science; Major GPA: 3.38.}{2018}
...
\begin{itemize}
\item Compared different Scikit-learn machine learning algorithms in Python for predicting whether mushrooms were toxic or edible.
\end{itemize}
...
\vspace{\normspace}
\begin{tabular}{@{}rl}
\textbf{Languages}: & Python, Java, JavaScript, C\#, SQL, C, HTML, CSS, \LaTeX \\
\textbf{Data Science}: & Scikit-learn, Pandas, Numpy, Snowflake, ZooKeeper \\
\textbf{Web}: & Spring, Hibernate, Express, React, Ember.js, Node.js, ASP.NET \\
\textbf{Infrastructure}: & AWS, Terraform, Jenkins, Docker
\end{tabular}
