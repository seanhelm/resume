...
\job{Amazon}{Software Development Engineer}{April 2019 --}
\begin{itemize}
\item Building out inventory management forecasting for sellers using Fulfillment By Amazon (FBA).
\end{itemize}

\job{Capital One}{Software Engineer}{Sep 2018 -- April 2019}
\begin{itemize}
